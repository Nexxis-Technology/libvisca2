...
#ifdef VISCA_WIN
const char *ttydev = "COM1:";
#else
const char *ttydev = "/dev/ttyS0";
#endif
...
void close_interface() {
    ...
    if (VISCA_unread_bytes(&iface, packet, &buffer_size) != VISCA_SUCCESS) {
        ...
        for (i = 0; i < buffer_size; i++) fprintf(stderr, "%2x ", packet[i]);
        fprintf(stderr, "\n");
    }
...
int doCommand(char *commandline, int *ret1, int *ret2, int *ret3) {
    ...
    if (strcmp(command, "set_pantilt_limit_downleft_clear") == 0) {
        if (VISCA_set_pantilt_limit_downleft_clear(&iface, &camera) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_limit_upright_clear") == 0) {
        if (VISCA_set_pantilt_limit_upright_clear(&iface, &camera) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_exp_comp_power") == 0) {
        ...
        if (VISCA_set_exp_comp_power(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_slow_shutter_auto") == 0) {
        ...
        if (VISCA_set_slow_shutter_auto(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_backlight_comp") == 0) {
        ...
        if (VISCA_set_backlight_comp(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_zero_lux_shot") == 0) {
        ...
        if (VISCA_set_zero_lux_shot(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_title_display") == 0) {
        ...
        if (VISCA_set_title_display(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_focus_far_speed") == 0) {
        ...
        if (VISCA_set_focus_far_speed(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_focus_near_speed") == 0) {
        ...
        if (VISCA_set_focus_near_speed(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_focus_near_limit") == 0) {
        ...
        if (VISCA_set_focus_near_limit(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_auto_exp_mode") == 0) {
        ...
        if (!((intarg1 == 0) || (intarg1 == 3) || (intarg1 == 10) || (intarg1 == 11) || (intarg1 == 13))) {
            return 41;
        }
    ...
    if (strcmp(command, "set_digital_effect") == 0) {
        ...
        if (VISCA_set_digital_effect(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_digital_effect_level") == 0) {
        ...
        if (VISCA_set_digital_effect_level(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_zoom_and_focus_value") == 0) {
        ...
        if (VISCA_set_zoom_and_focus_value(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_up") == 0) {
        ...
        if (VISCA_set_pantilt_up(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_down") == 0) {
        ...
        if (VISCA_set_pantilt_down(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_left") == 0) {
        ...
        if (VISCA_set_pantilt_left(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_right") == 0) {
        ...
        if (VISCA_set_pantilt_right(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_upleft") == 0) {
        ...
        if (VISCA_set_pantilt_upleft(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_upright") == 0) {
        ...
        if (VISCA_set_pantilt_upright(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_downleft") == 0) {
        ...
        if (VISCA_set_pantilt_downleft(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_downright") == 0) {
        ...
        if (VISCA_set_pantilt_downright(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_stop") == 0) {
        ...
        if (VISCA_set_pantilt_stop(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_limit_upright") == 0) {
        ...
        if (VISCA_set_pantilt_limit_upright(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_limit_downleft") == 0) {
        ...
        if (VISCA_set_pantilt_limit_downleft(&iface, &camera, intarg1, intarg2) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_absolute_position") == 0) {
        ...
        if (VISCA_set_pantilt_absolute_position(&iface, &camera, intarg1, intarg2, intarg3, intarg4) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_pantilt_relative_position") == 0) {
        ...
        if (VISCA_set_pantilt_relative_position(&iface, &camera, intarg1, intarg2, intarg3, intarg4) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_title_params") == 0) {
        ...
        temptitle = (VISCATitleData_t *)malloc((sizeof(unsigned int) * 4) + sizeof(unsigned char *));
    ...
    if (strcmp(command, "set_date_time") == 0) {
        ...
        if (VISCA_set_date_time(&iface, &camera, intarg1, intarg2, intarg3, intarg4, intarg5) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "get_exp_comp_power") == 0) {
        if (VISCA_get_exp_comp_power(&iface, &camera, &value8) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value8;
        return 11;
    ...
    if (strcmp(command, "get_backlight_comp") == 0) {
        if (VISCA_get_backlight_comp(&iface, &camera, &value8) != VISCA_SUCCESS) {
            return 46;
        }
        if (value8 == 2) {
            *ret1 = 1;
    ...
    if (strcmp(command, "get_focus_auto_sense") == 0) {
        if (VISCA_get_focus_auto_sense(&iface, &camera, &value8) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value8;
        return 11;
    ...
    if (strcmp(command, "get_focus_near_limit") == 0) {
        if (VISCA_get_focus_near_limit(&iface, &camera, &value16) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value16;
        return 11;
    ...
    if (strcmp(command, "get_slow_shutter_auto") == 0) {
        if (VISCA_get_slow_shutter_auto(&iface, &camera, &value8) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value8;
        return 11;
    ...
    if (strcmp(command, "get_shutter_value") == 0) {
        if (VISCA_get_shutter_value(&iface, &camera, &value16) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value16;
        return 11;
    ...
    if (strcmp(command, "get_exp_comp_value") == 0) {
        if (VISCA_get_exp_comp_value(&iface, &camera, &value16) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value16;
        return 11;
    ...
    if (strcmp(command, "get_aperture_value") == 0) {
        if (VISCA_get_aperture_value(&iface, &camera, &value16) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value16;
        return 11;
    ...
    if (strcmp(command, "get_picture_effect") == 0) {
        if (VISCA_get_picture_effect(&iface, &camera, &value8) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value8;
        return 11;
    ...
    if (strcmp(command, "get_digital_effect") == 0) {
        if (VISCA_get_digital_effect(&iface, &camera, &value8) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value8;
        return 11;
    ...
    if (strcmp(command, "get_digital_effect_level") == 0) {
        if (VISCA_get_digital_effect_level(&iface, &camera, &value16) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value16;
        return 11;
    ...
    if (strcmp(command, "get_pantilt_maxspeed") == 0) {
        if (VISCA_get_pantilt_maxspeed(&iface, &camera, &value8, &value8b) != VISCA_SUCCESS) {
            return 46;
        }
        *ret1 = value8;
        *ret2 = value8b;
    ...
    if (strcmp(command, "set_atmd_framedisplay_onoff") == 0) {
        if (VISCA_set_atmd_framedisplay_onoff(&iface, &camera) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_atmd_framedisplay") == 0) {
        ...
        if (VISCA_set_atmd_framedisplay(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_at_frameoffset") == 0) {
        ...
        if (VISCA_set_at_frameoffset(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_measure_mode1") == 0) {
        ...
        if (VISCA_set_md_measure_mode1(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_measure_mode2") == 0) {
        ...
        if (VISCA_set_md_measure_mode2(&iface, &camera, boolarg) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_wide_con_lens") == 0) {
        ...
        if (VISCA_set_wide_con_lens(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_at_chase") == 0) {
        ...
        if (VISCA_set_at_chase(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_at_entry") == 0) {
        ...
        if (VISCA_set_at_entry(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_adjust_ylevel") == 0) {
        ...
        if (VISCA_set_md_adjust_ylevel(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_adjust_huelevel") == 0) {
        ...
        if (VISCA_set_md_adjust_huelevel(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_adjust_size") == 0) {
        ...
        if (VISCA_set_md_adjust_size(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_adjust_disptime") == 0) {
        ...
        if (VISCA_set_md_adjust_disptime(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_adjust_refmode") == 0) {
        ...
        if (VISCA_set_md_adjust_refmode(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
    ...
    if (strcmp(command, "set_md_adjust_reftime") == 0) {
        ...
        if (VISCA_set_md_adjust_reftime(&iface, &camera, intarg1) != VISCA_SUCCESS) {
            return 46;
        }
        return 10;
    }
